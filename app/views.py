...
def index():
    ...
    messages = [i for i in current_app.database.messages_in_period(session.get('from', '0.0.0.0 0:0:0'), session.get('to', '0.0.0.0 0:0:0'), session.get('channel', 'chat_ru'), session.get('nickname', None))]
